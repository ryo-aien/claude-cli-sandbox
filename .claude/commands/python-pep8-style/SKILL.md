...
description: PEP8準拠のPythonコーディング規約チェックとリファクタリング支援。Pythonコードのスタイルレビュー、命名規則の修正、インデント・空白の調整、インポート整理、ドキュストリング追加などの作業時に使用。「PEP8」「Python規約」「コードスタイル」「リント」「フォーマット」などのキーワードで発動。
---
